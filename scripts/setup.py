...
# Prepare the dataset
dataset = QADataSet.from_text_files(["../data/textbooks.txt", "../data/lecture_notes.txt"])
...
summarization_model = SummarizationModel.from_pretrained("nvidia/summarization_model")
